...
test('touch can start a test sound in settings and pause',async({browser})=>{
 ...
 await page.locator('#setup-screen [data-settings-page=sound]').tap();await page.locator('#setup-screen [data-audio-test]').tap();
 ...
 await page.locator('#pause-overlay [data-settings-page=sound]').tap();await page.locator('#pause-overlay [data-audio-test]').tap();
