...
export function playingRoster(team){
 ...
 return [...team.roster,{id:`${team.id}-generic-15`,slot:'WR3',position:'WR',firstName:SUPPORT_FIRST[seed%SUPPORT_FIRST.length],lastName:SUPPORT_LAST[Math.floor(seed/13)%SUPPORT_LAST.length],number:availableNumber(used,15),rating:team.ratings.genericOffense||68,age:21,development:'Supporting player',generic:true}];
}
