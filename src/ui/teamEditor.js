...
function ensureUI(){
 ...
 @media(orientation:landscape) and (max-height:500px){
  ...
  .team-editor-sprite{width:90px;height:90px}.team-editor-preview #team-editor-status{font-size:11px;line-height:1.2}
