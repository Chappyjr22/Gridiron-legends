...
function ensureUI(){
 ...
 .team-editor-select{width:100%;min-height:44px;background:#172d46;border:2px solid #567493;color:#f5edcf;padding:8px;font:800 11px "Courier New",monospace}.team-editor-preview{display:grid;place-items:center;gap:8px;min-height:190px;text-align:center;background:linear-gradient(#173451,#0a1824);border:2px solid #45657c;padding:10px}.team-editor-badge{width:64px;height:64px;display:grid;place-items:center;background:var(--p);border:5px solid var(--a);color:#fff;font:900 18px Impact,"Arial Black",sans-serif;box-shadow:4px 4px 0 #000}.team-editor-uniform{position:relative;width:94px;height:112px}.team-editor-pants{position:absolute;left:33px;top:82px;width:30px;height:28px;background:var(--pants);border-left:4px solid var(--stripe);border-right:4px solid var(--stripe);clip-path:polygon(0 0,100% 0,100% 100%,60% 100%,50% 45%,40% 100%,0 100%)}.team-editor-helmet{position:absolute;left:29px;top:1px;width:38px;height:30px;border-radius:20px 20px 10px 10px;background:var(--helmet);border:3px solid #091117;box-shadow:inset 4px 0 rgba(255,255,255,.12)}.team-editor-helmet:after{content:"";position:absolute;left:15px;top:0;width:5px;height:28px;background:var(--stripe)}.team-editor-jersey{position:absolute;left:17px;top:33px;width:62px;height:54px;clip-path:polygon(13% 0,87% 0,100% 24%,84% 37%,78% 100%,22% 100%,16% 37%,0 24%);background:var(--jersey)}.team-editor-jersey:after{content:"";position:absolute;left:28px;top:0;width:6px;height:54px;background:var(--stripe)}
